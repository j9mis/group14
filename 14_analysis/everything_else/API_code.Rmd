...
Note: Some counties will appear as null, preventing us from getting further information. From this point, we will hand code in the remaining counties that were left out. The file below has the hand entered data
```{r}
...
```
## US Census API    
The following functions request certain US Census data for each location in the dataset.  
```{r, warning=FALSE}
